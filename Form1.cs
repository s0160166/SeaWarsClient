...
namespace SeaWars
{
    public partial class Form1 : Form
    {
        ...
        public void CreateMaps()
        {
            ...
            startButton.Text = "Подключиться к игре";
            startButton.Font = new Font("Consolas", 18f, FontStyle.Bold);
            startButton.Click += new EventHandler(ConnectClient);
        ...
        public void ConnectClient(object sender, EventArgs e)
        {
            ...
            Client client = new Client(strMap);
            string result = client.Send();
            if (result != "Error")
            {
                Button pressedButton = sender as Button;
                pressedButton.Text = "Подключение установлено";
                pressedButton.Enabled = false;
                Thread.Sleep(1000);
                this.Controls.Remove(pressedButton);
            ...
            {
                Button pressedButton = sender as Button;
                pressedButton.Text = "Попробуйте ещё раз";
            }
        }
        ...
        public void PlayerShoot(object sender, EventArgs e)
        {
            ...
            Client client = new Client(x.ToString()+y.ToString()+'2');
